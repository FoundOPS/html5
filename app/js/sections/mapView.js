...
define(["db/session", "db/services", "tools/generalTools", "tools/dateTools", "tools/parameters", "ui/leaflet", "ui/ui"], function (session, dbServices, generalTools, dateTools, parameters, leaflet, ui) {
