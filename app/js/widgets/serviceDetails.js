'use strict';
define(["jquery", "db/services", "db/session", "db/models", "tools/kendoTools", "widgets/selectBox", "select2", "kendo", "jmaskmoney", "jautosize", "jtooltip"],
    ...
    var ServiceDetails = Widget.extend({
        ...
        _fieldFactories: {
            ...
            "SignatureField": function (field, fieldIndex, elementToAppendTo) {
                ...
                $("#sigClear").live('click', function () {$(".sigPad").jSignature("reset")});
