...
require(["jquery", "lib/kendo.web.min", "ui/kendoChanges", "ui/colorPicker", "developer"], function ($, a, b, c, developer) {
    var grid;
...
//keep track of the last selected item, for color selector
    ...
    var dataSource = new kendo.data.DataSource({
        transport:{
            read:{
                url:baseUrl + "GetStatuses?roleId=" + developer.GOTGREASE_ROLE_ID,
                type:"GET",
                dataType:"jsonp",
