...
ops.models.TrackPoint.createFromApiModel = function (apiModel) {
    ...
    return ops.models.TrackPoint(ops.Guid.convert(apiModel.RouteId), goog.Date.fromRfc822String(apiModel.CollectedTimeStamp),
...
ops.models.ResourceWithLastPoint.createFromApiModel = function (apiModel) {
    //noinspection JSUnresolvedVariable
    return ops.models.ResourceWithLastPoint(ops.Guid.convert(apiModel.EmployeeId), ops.Guid.convert(apiModel.VehicleId), apiModel.EntityName,
