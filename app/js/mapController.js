...
var drawTrackpoints = function (routeId) {
    ...
    var routeTrackPoints = routesTrackPoints.get(routeId);
    ...
    if (routeTrackPoints) {
        ...
        routesTrackPoints.set(routeId, ops.services.Status.LOADING);
        ops.services.getTrackPoints(ops.tools.formatDate(selectedDate), routeId, function (loadedTrackPoints) {
            ...
            routesTrackPoints.set(routeId, loadedTrackPoints);
        });
    }
};
