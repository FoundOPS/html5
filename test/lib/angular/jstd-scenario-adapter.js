 ...
 * Now, when you call <code>browser().navigateTo('map.html')</code> in your scenario test, the browser will open /your-prefix/map.html.
 * That matches the proxy, so JSTD will proxy this request to http://localhost:8000/map.html.
 */
