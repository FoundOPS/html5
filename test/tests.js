...
define(function (require) {
    var generalTools = require("tools/generalTools"),
        dateTools = require("tools/dateTools"),
        leaflet = require("ui/leaflet"),
        ui = require("ui/ui"),
        services = require("db/services");
//region Tools Tests
    describe("Tools", function () {
        describe("getDirection", function () {
            it("should convert degrees to a compass direction", function () {
                expect(generalTools.getDirection(488)).toEqual("SE");
            });
        });
        describe("dateEqual", function () {
            it("should check if two dates(without the time) are equal'", function () {
                ...
                expect(dateTools.dateEqual(date1, date2)).toBeTruthy();
            });
        });
        describe("newGuid", function () {
            it("should create a new GUID", function () {
                //expect("3df4").toMatch(/^(?:[0-9A-Za-z]{4})$/);
                expect(generalTools.newGuid()).toMatch(/^(?:[0-9A-Za-z]{8})-(?:[0-9A-Za-z]{4})-(?:[0-9A-Za-z]{4})-(?:[0-9A-Za-z]{4})-(?:[0-9A-Za-z]{12})$/);
            });
            it("should create a unique GUID", function () {
                var guid1 = generalTools.newGuid();
                var guid2 = generalTools.newGuid();
...
//region Map Tests
    describe("Map", function () {
        beforeEach(function () {
            require("../../../test/jasmine/jasmine").getFixtures().set('<div id="map"></div>');
        });
